    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-shrink-0">
          <div className="w-12 h-12 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
            {index + 1}
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-4 mb-3">
            ...
            <button
              ...
              className="bg-red-50 text-red-600 p-2 rounded-lg hover:bg-red-100 transition-colors flex-shrink-0"
  ...
  return (
    <AdminLayout>
      <div className="max-w-4xl mx-auto">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Featured Jobs Carousel</h1>
            ...
            {hasChanges && (
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  disabled={saving}
                  className="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors disabled:bg-gray-400 flex items-center gap-2"
                >
                  {saving ? (
                    <>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Featured Jobs</h3>
        ...
        {jobs.length > 0 && (
          <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-6">
            <h3 className="font-semibold text-gray-900 mb-3">How to Manage Featured Jobs</h3>
